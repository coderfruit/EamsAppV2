...
public class UpdateUtils {
    ...
    public static void checkUpdate_SelectDialog(final Activity activity, final Boolean showGeneralUpdate) {
        ...
        request.setVersionName(getVersionName(activity));
        ...
        SoapUtils.checkUpdateAsync(activity,request, new SoapListener(){
            ...
            public void onSuccess(int statusCode, SoapObject object) {
                ...
                if((checkUpdateInfoEntity.getType() > 0 || showGeneralUpdate) && isIgnoreVersion.equals("false")){
        ...
        //原实现方法
//        NetWorkRequestUtils.checkUpdateAsync(activity, request, new CheckUpdateCallback() {
//            @Override
...
//
//            @Override
//            public void onResponse(CheckUpdateResult response, int id) {
//                if (null == response) {
//                    ToastUtils.showToast(activity, activity.getString(R.string.update_toast));
//                    return;
//                }
//
...
//                }
//
//                final CheckUpdateInfoEntity checkUpdateInfoEntity = response.data;
//
//                String isIgnoreVersion = (String) SPUtils.get(activity,checkUpdateInfoEntity.getVersion(),"false");
//
//                if((checkUpdateInfoEntity.getType() > 0 || showGeneralUpdate) && isIgnoreVersion.equals("false")){
