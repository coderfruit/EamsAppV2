...
public class Query_Equip_Repair_Adapter  extends BaseAdapter {

    private List<RepairmentBillEntity> mDataList;
    private Context mContext;

    private ViewHolder mViewHolder;
    public Query_Equip_Repair_Adapter(Context context, List<RepairmentBillEntity> dataList) {
        mContext = context;
        mDataList = dataList;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            mViewHolder.mTv_SpareCount = convertView.findViewById(R.id.mTv_SpareCount);
    ...
    public static class ViewHolder {
        ...
        private TextView mTv_SpareCount;
