...
public class MaintenancePlanViewDataListAdapter extends BaseAdapter {
    ...
    public MaintenancePlanViewDataListAdapter(Context context, List<MaintenancePlanEntity> dataList) {
        mContext = context;
        mDataList = dataList;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.listview_item_maintenance_plan_activity, null);
