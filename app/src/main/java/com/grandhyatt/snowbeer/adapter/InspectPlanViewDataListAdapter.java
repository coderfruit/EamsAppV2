...
public class InspectPlanViewDataListAdapter extends BaseAdapter {
    ...
    public InspectPlanViewDataListAdapter(Context context, List<InspectionPlanEntity> dataList) {
        mContext = context;
        mDataList = dataList;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.listview_item_inspect_plan_activity, null);
