...
public class RepairmentExPlanViewDataListAdapter extends BaseAdapter {
    ...
    public RepairmentExPlanViewDataListAdapter(Context context, List<RepairmentExPlanEntity> dataList) {
        mContext = context;
        mDataList = dataList;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.listview_item_repairmentex_plan_activity, null);
        ...
        if (dataModel != null) {
            ...
            mViewHolder.mTv_wxjh.setText(dataModel.getRepairmentProjectName());
