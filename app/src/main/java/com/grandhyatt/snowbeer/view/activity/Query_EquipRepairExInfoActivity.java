...
import com.grandhyatt.snowbeer.adapter.Query_Equip_Repair_Ex_Adapter;
...
public class Query_EquipRepairExInfoActivity extends ActivityBase implements IActivityBase, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_query_equip_repair_ex_info);
    ...
    private void getRepairmentBillItems(String billID, final View view) {
        showLogingDialog();
        SoapUtils.getRepairmentBillItems(Query_EquipRepairExInfoActivity.this, billID, new SoapListener() {
            @Override
            public void onSuccess(int statusCode, SoapObject object) {
                dismissLoadingDialog();
                if (object == null) {
                    ToastUtils.showLongToast(Query_EquipRepairExInfoActivity.this, getString(R.string.submit_soap_result_err1));
                    return;
                }
                //判断接口连接是否成功
                if (statusCode != SoapHttpStatus.SUCCESS_CODE) {
                    ToastUtils.showLongToast(Query_EquipRepairExInfoActivity.this, getString(R.string.submit_soap_result_err2));
                    return;
                }
                //接口返回信息正常
                ...
                //校验接口返回代码
                if (result == null) {
                    ToastUtils.showLongToast(Query_EquipRepairExInfoActivity.this, "获取数据失败" + statusCode);
                    return;
                } else if (result.code != Result.RESULT_CODE_SUCCSED) {
                    ToastUtils.showLongToast(Query_EquipRepairExInfoActivity.this, "获取数据失败" + statusCode + result.msg);
                    return;
                }
            ...
            public void onFailure(int statusCode, String content, Throwable error) {
                dismissLoadingDialog();
                ToastUtils.showToast(Query_EquipRepairExInfoActivity.this, getString(R.string.submit_soap_result_err5, error));
            }

            @Override
            public void onFailure(int statusCode, SoapFault fault) {
                dismissLoadingDialog();
                ToastUtils.showToast(Query_EquipRepairExInfoActivity.this, getString(R.string.submit_soap_result_err4, fault));
            }
        });
    }
    ...
    public void requestNetworkDataByEquip(String corpID, String equipID, String deptID,String typeID) {
        ...
        SoapUtils.getEquipRepairExBills(Query_EquipRepairExInfoActivity.this, corpID, equipID,deptID, typeID,   currentLastIdx, new SoapListener() {
            ...
            public void onSuccess(int statusCode, SoapObject object) {
                ...
                //校验接口返回代码
                if (result == null) {
                    ToastUtils.showLongToast(Query_EquipRepairExInfoActivity.this, getString(R.string.submit_soap_result_err3));
                    return;
                } else if (result.code != Result.RESULT_CODE_SUCCSED) {
                    ToastUtils.showLongToast(Query_EquipRepairExInfoActivity.this, getString(R.string.submit_soap_result_err4, result.msg));
                    return;
                }
    ...
    private void ShowPopWindow(List<RepairmentBillItemEntity> data, View view) {
        ...
        showListPopupWindow(Query_EquipRepairExInfoActivity.this, view, list, null);
