...
public class Query_EquipMaintenanceInfoActivity extends ActivityBase implements IActivityBase, View.OnClickListener {
    ...
    private Query_Equip_Mainten_Adapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_query_equip_maintenance_info);
    ...
    public void requestNetworkDataByEquip(String corpID, String equipID, String deptID,String typeID) {
        ...
        SoapUtils.getEquipMaintenBills(Query_EquipMaintenanceInfoActivity.this, corpID, equipID, deptID, typeID,  currentLastIdx, new SoapListener() {
            @Override
            public void onSuccess(int statusCode, SoapObject object) {
                dismissLoadingDialog();
                if (object == null) {
                    ToastUtils.showLongToast(Query_EquipMaintenanceInfoActivity.this, getString(R.string.submit_soap_result_err1));
                    return;
                }
                //判断接口连接是否成功
                if (statusCode != SoapHttpStatus.SUCCESS_CODE) {
                    ToastUtils.showLongToast(Query_EquipMaintenanceInfoActivity.this, getString(R.string.submit_soap_result_err2));
                    return;
                }
                //接口返回信息正常
                String strData = object.getPropertyAsString(0);
                MaintenanceBillsResult result = new Gson().fromJson(strData, MaintenanceBillsResult.class);
                //校验接口返回代码
                if (result == null) {
                    ToastUtils.showLongToast(Query_EquipMaintenanceInfoActivity.this, getString(R.string.submit_soap_result_err3));
                    return;
                } else if (result.code != Result.RESULT_CODE_SUCCSED) {
                    ToastUtils.showLongToast(Query_EquipMaintenanceInfoActivity.this, getString(R.string.submit_soap_result_err4, result.msg));
                    return;
                }
                List<MaintenanceBillEntity> data = result.getData();
            ...
            public void onFailure(int statusCode, String content, Throwable error) {
                ...
                ToastUtils.showToast(Query_EquipMaintenanceInfoActivity.this, getString(R.string.submit_soap_result_err5, error));
            }
            ...
            public void onFailure(int statusCode, SoapFault fault) {
                ...
                mRefreshLayout.finishRefresh(false);
                mRefreshLayout.finishLoadMore(false);
                ToastUtils.showToast(Query_EquipMaintenanceInfoActivity.this, getString(R.string.submit_soap_result_err4, fault));
            }
        });
    }
}
