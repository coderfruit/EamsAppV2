...
public class WarningInfo_EquipInspectionActivity extends ActivityBase implements IActivityBase, View.OnClickListener {
    ...
    private Equip_Inspect_EntityDataListAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warning_info_equip_inspect);
    ...
    public void initView() {
        ...
        mToolBar.setMenuButtonOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                list.add("检验记录");
                final PopupWindowUtil popupWindow = new PopupWindowUtil(WarningInfo_EquipInspectionActivity.this, list);
    ...
    public void bindEvent() {
        ...
        mLv_DataList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                InspectionPlanEntity entity = (InspectionPlanEntity) mAdapter.getItem(position);
                ...
                Intent intent = new Intent(WarningInfo_EquipInspectionActivity.this, InspectReportActivity.class);
        ...
        if(_CorpID != null){
            ...
            SoapUtils.getInspectionPlan(this, _CorpID, currentLastIdx, new SoapListener() {
                ...
                public void onSuccess(int statusCode, SoapObject object) {
                    ...
                    if (object == null) {
                        ToastUtils.showLongToast(WarningInfo_EquipInspectionActivity.this, getString(R.string.submit_soap_result_err1));
                        return;
                    }
                    //判断接口连接是否成功
                    if (statusCode != SoapHttpStatus.SUCCESS_CODE) {
                        ToastUtils.showLongToast(WarningInfo_EquipInspectionActivity.this, getString(R.string.submit_soap_result_err2));
                        return;
                    }
                    //接口返回信息正常
                    ...
                    //校验接口返回代码
                    if (result == null) {
                        ToastUtils.showLongToast(WarningInfo_EquipInspectionActivity.this, getString(R.string.submit_soap_result_err3));
                        return;
                    } else if (result.code != Result.RESULT_CODE_SUCCSED) {
                        ToastUtils.showLongToast(WarningInfo_EquipInspectionActivity.this, getString(R.string.submit_soap_result_err4, result.msg));
                        return;
                    }
                    ...
                    if (data != null && mIsLoadMore) {
                        ...
                        //设置数据
                        mAdapter = new Equip_Inspect_EntityDataListAdapter(WarningInfo_EquipInspectionActivity.this, data);
                ...
                public void onFailure(int statusCode, String content, Throwable error) {
                    ...
                    ToastUtils.showToast(WarningInfo_EquipInspectionActivity.this, getString(R.string.submit_soap_result_err5, error));
                }
    ...
    public void requestNetworkDataByEquip(String equipID) {
        ...
        if(equipID != null){
            String currentLastIdx = String.valueOf(mPageIndex * mPageSize);
            SoapUtils.getInspectionPlan_Equip(this, equipID, currentLastIdx, new SoapListener() {
                @Override
                public void onSuccess(int statusCode, SoapObject object) {
                    dismissLoadingDialog();
                    if (object == null) {
